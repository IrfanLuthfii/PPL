    ...
    <div class="row align-items-start">
        <div class="col">
            <div class="alert alert-success alert-dismissible">
                <h5><i class="fas fa-money-bill-wave"></i></i> Total Pemasukan Kas Zakat Penghasilan</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('KasPenghasilan/InsertKasMasuk') ?>
    ...
    <div class="modal fade" id="modal-edit<?= $value['id_kas_zakatpenghasilan'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('KasPenghasilan/UpdateKasMasuk/' . $value['id_kas_zakatpenghasilan']) ?>
                    <div class="form-group">
                        <label for="">Tanggal</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('KasPenghasilan/DeleteKasMasuk/' . $value['id_kas_zakatpenghasilan']) ?>" class="btn btn-danger">Ya</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
