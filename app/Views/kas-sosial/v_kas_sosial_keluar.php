<div class="col-md-12">
    ...
    <div class="alert alert-danger alert-dismissible">
        <h5><i class="fas fa-money-bill-wave"></i> Total Pengeluaran Kas Zakat Fitrah</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="<?= base_url('KasSosial/InsertKasKeluar')?>" enctype="multipart/form-data">
