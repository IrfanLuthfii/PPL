    ...
    <div class="row align-items-start">
        <div class="col">
             <div class="alert alert-success alert-dismissible">
                <h5><i class="fas fa-money-bill-wave"></i></i> Total Pemasukan Kas Zakat Mal</h5>
...
<div class="col-md-12">
    <div class="card card-success">
        ...
        <div class="card-header">
            <h3 class="card-title">Data Zakat Masuk</h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('KasMal/InsertKasMasuk') ?>
    ...
    <div class="modal fade" id="modal-edit<?= $value['id_kas_zakatmal'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('KasMal/UpdateKasMasuk/' . $value['id_kas_zakatmal']) ?>
                    <div class="form-group">
                        <label for="">Tanggal</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('KasMal/DeleteKasMasuk/' . $value['id_kas_zakatmal']) ?>" class="btn btn-danger">Ya</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
