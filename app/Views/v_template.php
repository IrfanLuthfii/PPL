...
<head>
    ...
    <title>MASJID AL-KHAIR| <?= $judul ?></title>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                    ...
                                    <li><a href="<?= base_url('Home/RekapKasSosial') ?>" class="dropdown-item">Rekap Kas Zakat Fitrah</a></li>
                                    <li><a href="<?= base_url('Home/RekapKasZakatMal') ?>" class="dropdown-item">Rekap Kas Zakat Mal</a></li>
                                    <li><a href="<?= base_url('Home/RekapKasZakatPenghasilan') ?>" class="dropdown-item">Rekap Kas Zakat Penghasilan</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('Home/Donasi') ?>" class="nav-link">Rekening</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('login') ?>" class="btn btn-block btn-success">
                                    <i class="fa fa-solid fa-user"></i> login
                                </a>
                            </li>
                        </ul>
                    </div>
