<div class="col-md-4">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Kirim Infaq Atau Zakat Ke Rekening Dibawah Ini</h3>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<div class="col-md-8">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Konfirmasi Infaq atau Zakat</h3>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select name="jenis_donasi" class="form-control">
                            ...
                            <option value="ZakatMal">Zakat Mal</option>
